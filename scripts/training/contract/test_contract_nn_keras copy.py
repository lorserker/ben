...
model_path = 'model/Contract_2024-12-08-E50.keras'  # Replace with your actual model path
...
contract, doubled = model.predict(x)


print("Contract probabilities:", contract)
print("Doubled probabilities:", doubled)

print("Sum of contract probabilities:", np.sum(contract, axis=1))
