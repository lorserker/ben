...
timeout /t 10 /nobreak >nul
rem Used from BBO 
start "TF2 Api external :80 (BBO)" python gameapi.py --config config\default_tf2_Short_imp_or_mp.conf --port 80 --host 0.0.0.0
timeout /t 10 /nobreak >nul
...
timeout /t 10 /nobreak >nul
start "TF2 GIB" python gameserver.py --config config\default_tf2_Short_imp_or_mp.conf --port 4447
timeout /t 10 /nobreak >nul
